...
contract DOGE_VACCINE is IBEP20, Auth {
    using SafeMath for uint256;
    string constant _name = "DOGE_VACCINE";
    string constant _symbol = "$DOGEVAC";
    ...
    uint256 public _maxTxAmount = 25000000000 * 10**6 * (10 ** _decimals);
    uint256 public _walletMax = 40000000000 * 10**6 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x74d5a59157cdb9691462F959e6737139485Fd714;
        devWallet = 0xBfDC5E8b2E8202A625B64F258D51218aC27364F3;
